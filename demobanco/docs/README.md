...
| Verificar límite diario | 100% | 100% (Test: testProcesarTransaccion, Gherkin: Escenario: Ingresar límite diario válido) |
| Transacción rechazada por monto mayor al límite diario | 50% (falta implementación en Java) | 100% (Gherkin: Escenario: Transacción rechazada por monto mayor al límite diario) |
| Transacción aprobada por monto menor o igual al límite diario | 50% (falta implementación en Java) | 100% (Gherkin: Escenario: Transacción aprobada por monto menor o igual al límite diario) |
| **Totales** | **83,33%** | **91,67%** |

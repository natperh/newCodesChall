...
Para ejecutar el servicio, puedes utilizar el comando `mvn spring-boot:run` (si estás utilizando Maven) o `gradle bootRun` (si estás utilizando Gradle). Luego, puedes acceder al servicio mediante una solicitud GET a `http://localhost:8080/suma?num1=2&num2=3`, por ejemplo.
